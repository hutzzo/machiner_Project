...
#define MSC_CLASS                             0x08 /* MSC（大容量存储） */
#define HID_CLASS                             0x03 /* HID（人机接口设备） */

#define USB_AUDIO                             0x01 /* 音频 */
#define USB_CDCC                              0x02 /* 通信和 CDC 控制 */
#define USB_HID                               0x03 /* HID（人机接口设备） */
#define USB_PRINTER                           0x07 /* 打印机 */
#define USB_MSC                               0x08 /* 大容量存储 */
#define USB_HUB                               0x09 /* 集线器 */
#define USB_CDCD                              0x0A /* CDC-Data */
#define USB_SMARTCARD                         0x0B /* 智能卡 */
#define USB_VIDEO                             0x0E /* 视频 */
#define USB_AVD                               0x10 /* 音频/视频设备 */
...
typedef enum {
  HOST_IDLE =0,//空闲
  HOST_WAIT_PRT_ENABLED,//等待电源prt
  HOST_DEV_ATTACHED,//设备已连接
  HOST_DEV_DISCONNECTED,  //设备断开
...
{
  HOST_State            gState;       /*  Host State Machine Value */ /* 主机状态机值 */
  HOST_State            gStateBkp;    /* backup of previous State machine value */ /* 前一个状态机值的备份 */
  ENUM_State            EnumState;    /* Enumeration state Machine */ /* 枚举状态机 */
