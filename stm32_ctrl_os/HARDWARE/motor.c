...
RCC_APB2PeriphClockCmd(RCC_APB2Periph_TIM9,ENABLE);/*使能定时器9时钟*/
RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOE,ENABLE);/*使能GPIOE时钟*/
...
TIM_ARRPreloadConfig(TIM9,ENABLE);/*自动重装载预装载使能*/
...
RCC_APB2PeriphClockCmd(RCC_APB2Periph_TIM10,ENABLE);/*使能定时器10时钟*/
...
TIM_ARRPreloadConfig(TIM10,ENABLE);/*自动重装载预装载使能*/

TIM_Cmd(TIM10,ENABLE);/*计数器使能*/
...
TIM_ARRPreloadConfig(TIM11,ENABLE);/*自动重装载预装载使能*/

TIM_Cmd(TIM11,ENABLE);/*计数器使能*/
