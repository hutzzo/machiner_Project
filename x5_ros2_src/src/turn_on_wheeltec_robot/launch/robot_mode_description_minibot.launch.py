...
def generate_launch_description():
    V550_mec = LaunchConfiguration('V550_mec', default='false')
    V550_4wd = LaunchConfiguration('V550_4wd', default='false')
    V550_akm = LaunchConfiguration('V550_akm', default='false')
    ...
    V550_4wd_ = GroupAction(
        condition=IfCondition(V550_4wd),
        actions=[
        generate_robot_node('V550_4wd_robot.urdf','V550_4wd'),
    ...
    V550_akm_ = GroupAction(
        condition=IfCondition(V550_akm),
        actions=[
        generate_robot_node('V550_akm_robot.urdf','V550_akm'),
        generate_static_transform_publisher_node(['0.03163', '0.00009', '0.09502'], ['0', '0', '0'], 'base_footprint', 'laser'),
        generate_static_transform_publisher_node(['0.10709', '0.00032', '0.0762'], ['0', '0', '0'], 'base_footprint', 'camera_link'),    
    ])
    ...
    ld.add_action(V550_mec_)
    ld.add_action(V550_4wd_)
    ld.add_action(V550_akm_)
