...
def generate_launch_description():
    #S100
    S100_diff_robot = LaunchConfiguration('S100_diff_robot', default='false')
    #S200
    S200_diff_robot = LaunchConfiguration('S200_diff_robot', default='false')
    #akm
    ...
    #S100
    S100_diff_robot_ = GroupAction(
        condition=IfCondition(S100_diff_robot),
        actions=[
        generate_robot_node('S100_diff_robot.urdf','S100_diff'),
    ...
    #S200 
    S200_diff_robot_ = GroupAction(
        condition=IfCondition(S200_diff_robot),
        actions=[
        generate_robot_node('S200_diff_robot.urdf','S200_diff'),
        generate_static_transform_publisher_node(['0.08874 ', '0.00067', '0.11102'], ['0', '0', '0'], 'base_footprint', 'laser'),
        generate_static_transform_publisher_node(['0.16578 ', '0.00095', '1.0897'], ['0', '0', '0'], 'base_footprint', 'camera_link'),      
    ]) 
    ...
    #add S100
    ld.add_action(S100_diff_robot_)
    #add S200
    ld.add_action(S200_diff_robot_)
    #add akm*3
