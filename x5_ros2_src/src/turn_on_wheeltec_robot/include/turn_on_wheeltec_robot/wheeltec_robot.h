...
#define MOVEIT_HEADER      0XAA
#define MOVEIT_TAIL        0XBB
...
class turn_on_robot : public rclcpp::Node
{
	...
	private:
		...
		rclcpp::Subscription<std_msgs::msg::Float32MultiArray>::SharedPtr Moveit_Sub;
		...
		void Moveit_Joint_Callback(const std_msgs::msg::Float32MultiArray::SharedPtr msg);
